...
<form action="index.php?controller=patientRendezvous&action=add" method="POST" class="col-4 mx-auto form-patient-rendezvous mb-5">
    
    <div class="text-center mb-2"><?= $msg ?></div>
    
    <div class="text-center my-3 fs-2 bold"><ins>Informations Patient</ins></div>
    ...
    <div class="text-center my-3 fs-2 bold"><ins>Informations Rendez-vous</ins></div>
